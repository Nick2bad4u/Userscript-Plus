...
`;
    ...
    const builtinList = {
        ...
        finance: /school|pay|bank|money|cart|checkout|authorize|bill|wallet|venmo|zalo|skrill|bluesnap|coin|crypto|currancy|insurance|finance/,
        ...
        engines: [
            {
                ...
                query: encodeURIComponent(
                    "https://greasyfork.org/scripts/by-site/{host}.json?language=all"
                ),
            },
            {
                enabled: false,
                name: "sleazyfork",
                query: encodeURIComponent(
                    "https://sleazyfork.org/scripts/by-site/{host}.json?language=all"
                ),
            },
            {
                enabled: false,
    ...
    const normalizeTarget = (target, toQuery = true, root) => {
        ...
        if (typeof target === "string") {
            return toQuery
                ? Array.from((root || document).querySelectorAll(target))
            : [target];
        }
        if (isElem(target)) {
            return [target];
    ...
    const iconSVG = {
        ...
        hide: {
            viewBox: "0 0 24 24",
            html:
            '<g> <path fill-rule="evenodd" clip-rule="evenodd" d="M2 11.5C2 10.9477 2.44772 10.5 3 10.5L21 10.5C21.5523 10.5 22 10.9477 22 11.5V12.5C22 13.0523 21.5523 13.5 21 13.5H3C2.44772 13.5 2 13.0523 2 12.5V11.5Z" fill="currentColor"></path></g>',
        },
        install: {
            viewBox: "0 0 16 16",
            html:
            '<g><path d="M8.75 1.75a.75.75 0 00-1.5 0v6.59L5.3 6.24a.75.75 0 10-1.1 1.02L7.45 10.76a.78.78 0 00.038.038.748.748 0 001.063-.037l3.25-3.5a.75.75 0 10-1.1-1.02l-1.95 2.1V1.75z"/><path d="M1.75 9a.75.75 0 01.75.75v3c0 .414.336.75.75.75h9.5a.75.75 0 00.75-.75v-3a.75.75 0 011.5 0v3A2.25 2.25 0 0112.75 15h-9.5A2.25 2.25 0 011 12.75v-3A.75.75 0 011.75 9z"/></g>',
        },
        issue: {
            viewBox: "0 0 24 24",
            html:
            '<path fill="none" stroke="#ffff" stroke-width="2" d="M23,20 C21.62,17.91 20,17 19,17 M5,17 C4,17 2.38,17.91 1,20 M19,9 C22,9 23,6 23,6 M1,6 C1,6 2,9 5,9 M19,13 L24,13 L19,13 Z M5,13 L0,13 L5,13 Z M12,23 L12,12 L12,23 L12,23 Z M12,23 C8,22.9999998 5,20.0000002 5,16 L5,9 C5,9 8,6.988 12,7 C16,7.012 19,9 19,9 C19,9 19,11.9999998 19,16 C19,20.0000002 16,23.0000002 12,23 L12,23 Z M7,8 L7,6 C7,3.24 9.24,1 12,1 C14.76,1 17,3.24 17,6 L17,8"/>',
        },
        nav: {
            viewBox: "0 0 24 24",
            html:
            '<g><path d="M2 5.5C2 4.94772 2.44772 4.5 3 4.5H21C21.5523 4.5 22 4.94772 22 5.5V6.5C22 7.05228 21.5523 7.5 21 7.5H3C2.44772 7.5 2 7.05228 2 6.5V5.5Z" fill="currentColor"></path> <path d="M2 11.5C2 10.9477 2.44772 10.5 3 10.5H21C21.5523 10.5 22 10.9477 22 11.5V12.5C22 13.0523 21.5523 13.5 21 13.5H3C2.44772 13.5 2 13.0523 2 12.5V11.5Z" fill="currentColor"></path><path d="M3 16.5C2.44772 16.5 2 16.9477 2 17.5V18.5C2 19.0523 2.44772 19.5 3 19.5H21C21.5523 19.5 22 19.0523 22 18.5V17.5C22 16.9477 21.5523 16.5 21 16.5H3Z" fill="currentColor"></path></g>',
        },
        plus: {
            viewBox: "0 0 24 24",
            html:
            '<g><path d="M13.5 3C13.5 2.44772 13.0523 2 12.5 2H11.5C10.9477 2 10.5 2.44772 10.5 3V10.5H3C2.44772 10.5 2 10.9477 2 11.5V12.5C2 13.0523 2.44772 13.5 3 13.5H10.5V21C10.5 21.5523 10.9477 22 11.5 22H12.5C13.0523 22 13.5 21.5523 13.5 21V13.5H21C21.5523 13.5 22 13.0523 22 12.5V11.5C22 10.9477 21.5523 10.5 21 10.5H13.5V3Z" fill="currentColor"/></g>',
        },
        search: {
            viewBox: "0 0 24 24",
            html:
            '<g><path fill-rule="evenodd" clip-rule="evenodd" d="M10 0.5C4.75329 0.5 0.5 4.75329 0.5 10C0.5 15.2467 4.75329 19.5 10 19.5C12.082 19.5 14.0076 18.8302 15.5731 17.6944L20.2929 22.4142C20.6834 22.8047 21.3166 22.8047 21.7071 22.4142L22.4142 21.7071C22.8047 21.3166 22.8047 20.6834 22.4142 20.2929L17.6944 15.5731C18.8302 14.0076 19.5 12.082 19.5 10C19.5 4.75329 15.2467 0.5 10 0.5ZM3.5 10C3.5 6.41015 6.41015 3.5 10 3.5C13.5899 3.5 16.5 6.41015 16.5 10C16.5 13.5899 13.5899 16.5 10 16.5C6.41015 16.5 3.5 13.5899 3.5 10Z" fill="currentColor"/></g>',
        },
        verified: {
            viewBox: "0 0 56 56",
            fill: "currentColor",
        ...
        load(type, container) {
            const safe = safeSelf();
            const svgElem = safe.createElementNS(
    ...
    const sleazyRedirect = () => {
        ...
        if (
            !qs("#script-info") &&
            (otherSite == "greasyfork" ||
             qs("div.width-constraint>section>p>a"))
        ) {
    ...
    class Container {
        ...
        constructor(url) {
            ...
            : make("iframe", "mujs-iframe", {
                ...
                onload: (iFrame) => {
                    ...
                    this.ready = true;
                    dom.cl.add(
                        [this.shadowRoot, target.contentDocument.body],
                        "mujs-iframe"
                    );
                },
            });
            ...
            const Timeout = class {
                ...
                set(delay, reason) {
                    return new Promise((resolve, reject) => {
                        const id = setTimeout(() => {
                            Object.is(reason, null) ||
                                Object.is(reason, undefined)
                                ? resolve()
                            : reject(reason);
                            this.clear(id);
                        }, delay);
        ...
        async inject(callback, doc) {
            ...
            try {
                ...
                if (isNull(this.loadCSS(main_css, "primary-stylesheet"))) {
                    throw new Error("Failed to initialize script!", {
                        cause: "loadCSS",
                    });
                }
                this.injected = true;
            ...
            for (const engine of cfg.engines) {
                if (engine.enabled) {
                    const counter = make("count-frame", "", {
                        ...
                        title: engine.query
                        ? decodeURIComponent(engine.query)
                        : engine.url,
                        textContent: "0",
                    });
            ...
            class Tabs {
                ...
                hasTab(...params) {
                    for (const p of params) {
                        ...
                        const content = normalizeTarget(this.Tab.get(p)).filter(
                            (t) => p === t.dataset.host
                        );
                        if (isBlank(content)) {
                            return false;
                ...
                create(host = undefined) {
                    if (typeof host === "string") {
                        if (
                            host.startsWith(this.protocal) &&
                            this.hasTab(host)
                        ) {
                            this.active(this.Tab.get(host));
                            return;
                        }
                        const content = normalizeTarget(
                            this.storeTab(host)
                        ).filter((t) => host === t.dataset.host);
                        if (!isEmpty(content)) {
                            return;
                        }
                    }
        ...
        init() {
            try {
                ...
                this.btnhome = make("mujs-btn", "github hidden", {
                    title: `GitHub (v${
                        $info.script.version.includes(".") ||
                    $info.script.version.includes("Book")
                    ? $info.script.version
                ...
                this.btnissue = make("mujs-btn", "issue hidden", {
                    ...
                    dataset: {
                        ...
                        webpage:
                        $info.script.bugs ??
                        "https://github.com/magicoflolis/Userscript-Plus/issues",
                    },
                });
        ...
        loadCSS(css, name = "CSS") {
            try {
                if (typeof name !== "string") {
                    throw new Error('"name" must be a typeof "string"', {
                        cause: "loadCSS",
                    });
                }
                ...
                if (isBlank(css)) {
                    throw new Error(`"${name}" contains empty CSS string`, {
                        cause: "loadCSS",
                    });
                }
                const parent = isEmpty(this.root.shadowRoot)
                ? this.root
        ...
        updateCounters() {
            for (const [k, v] of Object.entries(this.counters)) {
                ...
                if (qs(`count-frame[data-counter="${k}"]`, this.countframe)) {
                    dom.text(
                        qs(`count-frame[data-counter="${k}"]`, this.countframe),
                        v
                    );
                }
            }
        ...
        refresh() {
            ...
            dom.cl.remove(
                qsA("mujs-section[data-name]", this.cfgpage),
                "hidden"
            );
            dom.prop(
                [this.tabbody, this.rateContainer, this.footer],
                "innerHTML",
                ""
            );
        }
        ...
        try {
                ...
                try {
                    ...
                    if (cmd === "install-script" && dataset.userjs) {
                        ...
                        if (!prmpt && dataset.userjs.endsWith(".user.css")) {
                            ...
                            installCode = dataset.userjs.replace(
                                /\.user\.css$/,
                                ".user.js"
                            );
                        }
                        ...
                        if (dom.cl.has(btngreasy, "hidden")) {
                            dom.cl.remove(
                                [btncfg, btngreasy, btnhome, btnissue],
                                "hidden"
                            );
                        } else {
                            dom.cl.add(
                        ...
                        const dataUserJS = container.userjsCache.get(
                            +dataset.userjs
                        );
                        let installCode = dataUserJS.code_url;
                        if (
                            !prmpt &&
                            dataUserJS.code_url.endsWith(".user.css")
                        ) {
                            container.makePrompt(
                                "Download as UserStyle?",
                                dataset
                            );
                            return;
                        } else if (prmpt !== prmptChoice) {
                            installCode = dataUserJS.code_url.replace(
                                /\.user\.css$/,
                                ".user.js"
                            );
                        }
                        ...
                        const userjsExt =
                              prmpt !== prmptChoice ? ".user.js" : ".user.css";
                        const makeUserJS = new Blob([txt], {
                            type: "text/plain",
                        });
                        ...
                        const dlBtn = make("a", "mujs-exporter", {
                            ...
                            download: `Magic_Userscript_${
                                cmd === "export-cfg" ? "config" : "theme"
                        }.json`,
                        });
                        dlBtn.click();
                        URL.revokeObjectURL(dlBtn.href);
            ...
            if (!isMobile) {
                const fade = async (target, type) => {
                    if (type === "mouseenter") {
                        ...
                        container.timeouts.mouse.clear(
                            ...container.timeouts.mouse.ids
                        );
            ...
            class ParseUserJS {
                ...
                get_meta_block() {
                    ...
                    const end_block = this.code.indexOf(
                        META_END_COMMENT,
                        start_block
                    );
                    if (isNull(end_block)) {
                    ...
                    const meta_block = this.code.substring(
                        start_block + META_START_COMMENT.length,
                        end_block
                    );
                ...
                parse_meta() {
                    ...
                    for (const meta_line of meta_block.split("\n")) {
                        const meta_match = meta_line.match(
                            /\/\/\s+@([a-zA-Z:-]+)\s+(.*)/
                        );
            ...
            const timeoutFrame = async (time) => {
                ...
                if (typeof time === "number" && !Number.isNaN(time)) {
                    await frameTimeout.set(
                        container.isBlacklisted ? time / 2 : time
                    );
                } else {
            ...
            const createjs = (ujs, engine) => {
                ...
                const fcreated = make("mu-js", "mujs-list", {
                    textContent: `${i18n$("created_date")}: ${language.toDate(
                        ujs.created_at
                    )}`,
                });
                const flicense = make("mu-js", "mujs-list", {
                    title: ujs.license ?? i18n$("no_license"),
                    textContent: `${i18n$("license")}: ${
                        ujs.license ?? i18n$("no_license")
                }`,
                    style:
                ...
                const ftotal = make("mu-js", "mujs-list", {
                    textContent: `${i18n$(
                        "total_installs"
                    )}: ${language.toNumber(ujs.total_installs)}`,
                });
                ...
                const scriptDownload = make("mu-jsbtn", "", {
                    innerHTML: `${iconSVG.load("install")} ${i18n$(
                        "saveFile"
                    )}`,
                    dataset: {
                ...
                const loadCode = make("mu-jsbtn", "", {
                    innerHTML: `${iconSVG.load("search")} ${i18n$(
                        "preview_code"
                    )}`,
                    dataset: {
                        command: "load-userjs",
            ...
            class List {
                ...
                set host(hostname) {
                    ...
                    this.engines = cfg.engines.filter(
                        (e) => e.enabled && isSupported(e.name)
                    );
                    ...
                    try {
                        ...
                        for (const engine of this.engines) {
                                        ...
                                        code: {
                                            ...
                                            translate = false,
                                             code_url
                                                ...
                                                const afSet = new Set();
                                                const code_obj = new ParseUserJS(
                                                    code
                                                );
                                                ...
                                                for (const [
                                                    ...
                                                    if (/grant/.test(key)) {
                                                        for (const v of normalizeTarget(
                                                            value,
                                                            false
                                                        )) {
                                                            if (
                            ...
                            const forkFN = async (dataQ) => {
                                if (!dataQ) {
                                    showError(
                                        "Invalid data received from the server, check internet connection"
                                    );
                                    return;
                                }
                                /**
                                ...
                                for (const ujs of otherLng) {
                                    const c = await ujs._mujs.code.request(
                                        true
                                    );
                                    if (c.translated) {
                                        hds.push(ujs);
                            ...
                            const openuserjs = async (htmlDocument) => {
                                try {
                                    if (!htmlDocument) {
                                        showError(
                                            "Invalid data received from the server, TODO fix this"
                                        );
                                        return;
                                    }
                                    const selected =
                            ...
                            if (/github/gi.test(engine.name)) {
                                if (isEmpty(engine.token)) {
                                    showError(
                                        `"${engine.name}" requires a token to use`
                                    );
                                    continue;
                                }
                                netFN = Network.req(
                                ...
                                netFN = Network.req(
                                    toQuery(
                                        `${engine.url}/scripts/by-site/${host}.json?language=all`
                                    )
                                )
                                    .then(forkFN)
                                    .catch(showError);
                        ...
                        Promise.allSettled(arr).then(() => {
                            tabhead.rows[0].cells[2].dispatchEvent(
            ...
            const makecfg = () => {
                const makerow = (desc, type = null, nm, attrs = {}) => {
                    ...
                    if (type === "checkbox") {
                        ...
                        if (
                            /(greasy|sleazy)fork|openuserjs|gi(thub|st)/gi.test(
                                nm
                            )
                        ) {
                            for (const engine of cfg.engines) {
                                ...
                                if (engine.query) {
                                    const d = DEFAULT_CONFIG.engines.find(
                                    ...
                                    const urlInp = make("input", "", {
                                        ...
                                        onchange(evt) {
                                            ...
                                            container.rebuild = true;
                                            try {
                                                engine.query = encodeURIComponent(
                                                    new URL(
                                                        evt.target.value
                                                    ).toString()
                                                );
                ...
                for (const inp of [
                    ...
                    const nm =
                          inp.dataset.name === "recommend-author"
                    ? "author"
                    : "others";
            ...
            ael(urlBar, "input", (evt) => {
                ...
                if (isEmpty(val)) {
                    ...
                    dom.cl.remove(
                        qsA("mujs-section[data-name]", cfgpage),
                        "hidden"
                    );
                    return;
                }
                ...
                if (!dom.cl.has(cfgpage, "hidden")) {
                    ...
                    for (const elem of qsA(
                        "mujs-section[data-name]",
                        cfgpage
                    )) {
                        if (!elem) {
                            continue;
    ...
    const loadDOM = (onDomReady) => {
        ...
        document.addEventListener(
            "DOMContentLoaded",
            (evt) => onDomReady.call({}, evt.target),
            {
                once: true,
            }
        );
        ...
        loadDOM((doc) => {
            try {
                if (window.location === null) {
                    throw new Error(
                        '"window.location" is null, reload the webpage or use a different one'
                    );
                }
                if (doc === null) {
                    throw new Error(
                        '"doc" is null, reload the webpage or use a different one'
                    );
                }
